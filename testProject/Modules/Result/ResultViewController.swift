...
class ResultViewController: UIViewController {
    ...
    private let speechBubbleView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(red: 0.8, green: 0.85, blue: 1.0, alpha: 1.0)
    ...
    init(petImage: UIImage) {
        ...
        self.translatedText = TranslationData.randomPhrase()
    ...
    private func setupSubviews() {
        view.backgroundColor = UIColor(red: 0.94, green: 0.97, blue: 0.98, alpha: 1.0)
        ...
        speechLabel.text = translatedText
